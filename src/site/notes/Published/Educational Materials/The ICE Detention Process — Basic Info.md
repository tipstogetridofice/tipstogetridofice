---
{"dg-publish":true,"permalink":"/published/educational-materials/the-ice-detention-process-basic-info/"}
---
...
- ➡️ [[Published/Educational Materials/Know Your Rights\|Know Your Rights]]
- **In Minnesota** 
	- Asylees and refugees—including those with pending AOS applications—are being sent letters instructing them to report to Fort Snelling for a “check-in,” often without stating the reason. **These appointments can result in sudden detention.** ([source](https://docs.google.com/document/d/1EnacBDU1KBefoBekQRNvENwg3BdLVT12me1m7ZgEQOY/edit?tab=t.0))
	- Anyone with asylum or refugee status (with or without pending AOS) should have a habeas petition prepared in advance, ready to be filed immediately if ICE detains them. Families should also identify a Next Friend in advance in case the detained person cannot communicate or access the courts. ([source](https://docs.google.com/document/d/1EnacBDU1KBefoBekQRNvENwg3BdLVT12me1m7ZgEQOY/edit?tab=t.0))
...
- **In Minnesota** 
	- **Call the NLG Hotline 612-444-2654**
	...
	- This information **allows a habeas petition to be filed immediately,** even if an attorney is not yet involved. If the A-Number or detention location is unknown, the petition can still be filed, but families should continue trying to obtain that information as soon as possible ([source](https://docs.google.com/document/d/1EnacBDU1KBefoBekQRNvENwg3BdLVT12me1m7ZgEQOY/edit?tab=t.0)).
