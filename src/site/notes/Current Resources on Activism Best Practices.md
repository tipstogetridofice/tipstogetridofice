---
{"dg-publish":true,"permalink":"/current-resources-on-activism-best-practices/"}
---
...
- [Various Resources on Community Responses](https://defend612.com/resources/) to violence, oppression, etc. 
- *[Discover Human Rights: A Human Rights Approach to Social Justice](https://www.theadvocatesforhumanrights.org/Res/dhr_training_manual_2017%203.pdf).* 
	- Manual with three modules explaining how to become an advocate for human rights, written in 2017. 
- [Database of Materials for Human Rights Defenders](https://www.theadvocatesforhumanrights.org/Defenders) 
	- Includes manuals, explainers, lists of protection grants, etc. 
